...
const PRIVATE_ID = import.meta.env.VITE_PRIVATE_ID;
const CONTRACT_ADDRESS = import.meta.env.VITE_CONTRACT_ADDRESS;

export const client = createThirdwebClient({
     clientId: CLIENT_ID, secretKey: PRIVATE_ID});
...
export const contractABI =[
  ...
  },
  {
    ...
    "name": "BatchTransactionProcessed",
    "type": "event"
  },
  {
    "anonymous": false,
    ...
    "outputs": [
      {
        ...
        "internalType": "struct QuantumSpectra.BatchTransaction[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct QuantumSpectra.Transaction[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
  ...
  },
  {
    "inputs": [
      ...
      },
      {
        ...
        "internalType": "struct QuantumSpectra.Proof[]",
        "name": "proofs",
        "type": "tuple[]"
      }
    ],
...
export const CONSTRACT = getContract({
     client: client,
     chain: chain,
     abi: contractABI,
